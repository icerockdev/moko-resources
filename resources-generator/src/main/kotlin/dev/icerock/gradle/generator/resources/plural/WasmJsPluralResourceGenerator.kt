...
import dev.icerock.gradle.generator.addWasmJsContainerStringsLoaderProperty
import dev.icerock.gradle.generator.addWasmJsFallbackProperty
import dev.icerock.gradle.generator.addWasmJsSupportedLocalesProperty
...
internal class WasmJsPluralResourceGenerator(
    ...
    override fun generateBeforeProperties(
        ...
        builder.addSuperinterface(Constants.WasmJs.loaderHolderName)

        builder.addWasmJsFallbackProperty(
            fallbackFilePath = "./" + LOCALIZATION_DIR + "/" + getFileNameForLanguage(LanguageType.Base)
        )
        builder.addWasmJsSupportedLocalesProperty(
        ...
        builder.addWasmJsContainerStringsLoaderProperty()
    }
