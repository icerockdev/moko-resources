...
internal class PackResourcesToKLibAction(
    ...
    private val assetsDirectoryProvider: Provider<Directory>,
    private val resourcesGenerationDirProvider: Provider<Directory>,
) : Action<Task> {
    override fun execute(task: Task) {
        ...
        val assetsDirectory = assetsDirectoryProvider.get().asFile
